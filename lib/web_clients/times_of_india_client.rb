module WebClients
  class TimesOfIndiaClient
    include HTTParty
    base_uri 'https://timesofindia.indiatimes.com/'
    ...
    def fetch_article(article_url)
      ...
      title = parsed_dom.at_css("div[data-articlemsid] h1").text
      body = (parsed_dom.at_xpath("//div[@data-articlemsid]/section/following-sibling::div[1]") || parsed_dom.at_css("arttextxml"))&.text
