module CrawlPipeline
  class FetchWebLinkWorker
    ...
    # link_item = {:web_domain_id=>555, :web_link_id=>26965, :full_link=>"http://www.etimes.in, :score => 3"}
    def perform(link_item)
      ...
      CrawlManager::UrlFrontier.append_for_extraction(web_content, link_item['score'].to_f)
