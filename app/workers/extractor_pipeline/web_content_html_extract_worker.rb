module ExtractorPipeline
  class WebContentHtmlExtractWorker
    ...
    # web_link_item = {"web_domain_id"=>1, "web_link_id"=>1, "full_link"=>"https://timesofindia.indiatimes.com/", "web_content_id"=>2456}
    def perform(web_link_item)
      ...
      Extractors.process_extracted_items(web_link_item["web_content_id"], extracted_items)
    end
  end
end
